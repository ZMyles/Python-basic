...
#Submit============================
        self.btnSubmit = Button(self.master, text="Submit", width=20, height=2, command=self.submit)
        self.btnSubmit.grid(row=2, column=1, padx=(0, 0), pady=(30, 0))
  

        self.btnCancel = Button(self.master, text="Cancel", width=20, height=2, command=self.cancel)
